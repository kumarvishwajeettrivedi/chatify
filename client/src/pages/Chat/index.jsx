...
const Chat = () => {
  ...
  return (
    <div className="flex h-[100vh] w-[100vw] text-white overflow-hidden">
      ...
      {(isMobile && selectedChatType === undefined) || !isMobile ? (
        <ContactContainer className="w-[20vw] mobile-hidden" />
      ) :<ChatContainer className="flex-auto mobile-visible" /> }
      <div className="flex-auto flex h-full">
        {selectedChatType === undefined ? (
          <EmptyChatContainer className="flex-auto mobile-visible" />
        ) : (
          <ChatContainer className="flex-auto mobile-visible" />
        )}
      </div>
